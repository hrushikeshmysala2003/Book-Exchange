                    ...
                    <div>
                        ...
                        <form onSubmit={handleSubmit} className='border w-[80%] mx-auto p-5 shadow-md rounded-md'>
                            <div className='mb-3'>
                                ...
                                <input type="text" id='title' placeholder='Title' className='border w-full p-2 rounded-md focus:outline-none focus:ring focus:border-blue-400' required />
                            </div>
                            <div className='mb-3'>
                                <label htmlFor="author" className='block mb-2'>Author</label>
                                <input type="text" id='author' placeholder='Author' className='border w-full p-2 rounded-md focus:outline-none focus:ring focus:border-blue-400' required />
                            </div>
                            <div className='mb-3'>
                                <label htmlFor="category" className='block mb-2'>Category</label>
                                <input type="text" id='category' placeholder='Category (for e.g: educational,historic etc.. )' className='border w-full p-2 rounded-md focus:outline-none focus:ring focus:border-blue-400' required />
                            </div>
                            <div className='mb-3'>
                                ...
                                <textarea name='description' rows={5} id='description' placeholder='Description' className='border resize-none w-full p-2 rounded-md focus:outline-none focus:ring focus:border-blue-400' required />
                            </div>
                            <div className='mb-4'>
                                <label htmlFor="price" className='block mb-2'>Price <span className='select-none text-gray-300 text-sm ml-1'>₹ only</span></label>
                                <input type="number" id='price' placeholder='Price' className='border w-full p-2 rounded-md focus:outline-none focus:ring focus:border-blue-400 no-number-arrows' required />
                            </div>
                            <div className='mb-5'>
                                ...
                                <input type="file" id='book-img' className='rounded-md border border-gray-200 w-full text-base px-2 py-1 focus:outline-none focus:ring focus:border-blue-600' required />
                            </div>
                            <div>

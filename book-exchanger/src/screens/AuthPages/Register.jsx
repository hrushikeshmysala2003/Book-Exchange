    ...
    <div className="flex justify-center items-center h-screen bg-gradient-to-r from-green-400 to-blue-500"  >
        <form onSubmit={submitHandler} className="w-96 p-4 bg-white rounded-lg m-3" >
            ...
            <div className="w-20 my-3 h-20 flex justify-center mx-auto" >
              <img  className='rounded-full' src={ imagePrev ? imagePrev: "https://res.cloudinary.com/dwna7axtx/image/upload/v1690702045/ws0sv4eb57qlyakpt8nc.png" } alt="avatar" />
            </div>
            <div className="my-3 " >
                <label htmlFor="name" className="my-3 block text-base mb-2" >Name : </label>
                <input onChange={e => setName(e.target.value)} type="text" id='name' className=" rounded-md border border-gray-200 order w-full text-base px-2 py-1 focus:outline-none focus:ring focus:border-blue-600" placeholder="Enter your Name" />
            </div>
            <div className="my-3 " >
                <label htmlFor="email" className="my-3 block text-base mb-2" >Email : </label>
                <input onChange={e => setEmail(e.target.value)} type="email" id='email' className=" rounded-md border border-gray-200 order w-full text-base px-2 py-1 focus:outline-none focus:ring focus:border-blue-600" placeholder="Enter your Email" />
            </div>
            <div className="mt-3" >
                <label htmlFor="password" className="my-3 block text-base mb-2" >Password : </label>
                <input onChange={e => setPassword(e.target.value)} type="password" id='password' className=" rounded-md border border-gray-200 order w-full text-base px-2 py-1 focus:outline-none focus:ring focus:border-blue-600" placeholder="Enter Password" />
            </div>
            <div className="mt-3" >
                <label htmlFor="file" className="my-3 block text-base mb-2" >Profile picture : </label>
                <input onChange={fileUploadHandler} type="file" id='file' className=" rounded-md border border-gray-200 w-full text-base px-2 py-1 focus:outline-none focus:ring focus:border-blue-600" />
            </div>

    ...
    <div className="flex justify-center items-center h-screen bg-gradient-to-r from-green-400 to-blue-500"  >
        <div className="w-96 p-3 bg-white rounded-lg m-3" >
            ...
            <div className="w-20 my-3 h-20 flex justify-center mx-auto" >
              <img src="https://res.cloudinary.com/dwna7axtx/image/upload/v1690702045/ws0sv4eb57qlyakpt8nc.png" alt="" />
            </div>
            <div className="my-3 " >
                <label htmlFor="name" className="my-3 block text-base mb-2" >Name : </label>
                <input type="text" id='name' className=" rounded-md order w-full text-base px-2 py-1 focus:outline-none focus:ring focus:border-blue-600" placeholder="Enter your Name" />
            </div>
            <div className="my-3 " >
            ...
            <div className="mt-3" >
                ...
                <input  type="file" id='file' className=" rounded-md order w-full text-base px-2 py-1 focus:outline-none focus:ring focus:border-blue-600" />
            </div>

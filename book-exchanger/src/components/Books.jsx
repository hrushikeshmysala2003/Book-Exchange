        ...
        <>
            <div>
                <div className='text-center text-[36px] text-[#363A45] py-[2rem]'>
                    <h2>Best Selling <span class="bg-blue-100 text-blue-800 text-[36px] font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">Books</span></h2>
                </div>
                ...
                <div className='bg-[#F5F5F5] w-full flex justify-center p-[3rem]'>
                    <div className='flex flex-wrap justify-center w-[90%] gap-[2rem]'>
                        ...
                        {
                            data.map((book)=>{
                                const book_details={name:book.title,img:book.image,description:book.description,price:book.price}
